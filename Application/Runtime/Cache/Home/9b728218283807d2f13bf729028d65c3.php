...
<head>
  ...
  <link rel="stylesheet" href="/git/guan-tang/Public/css/gallery.css">
  ...
  <script src="/git/guan-tang/Public/js/gallery.js"></script>
</head>
<script>
...
<div id="sub-header-container">
  <ul id="sub-header" class="menu">
    <li id="sub-header-casestudies"><a href="/git/guan-tang/index.php/case" id="showcase">CASE STUDIES</a></li>
    <?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="/git/guan-tang/index.php/gallery/<?php echo ($data["term_id"]); ?>"><?php echo ($data["description"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
  </ul>
